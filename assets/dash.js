            ...
            <div class="user-dashboard-content">
                ...
                <div class="inline">
                    ...
                    <button onclick="window.open(${/Android/i.test(navigator.userAgent) 
                        ? `\`manager.php?scope=redirectToCalendar&UID=\${window.UID}\`, '_blank'` // https://calendar.google.com/calendar/u/0?cid=\${encodeURIComponent(\`webcal://\${location.hostname}/manager.php?scope=syncICal&UID=\${window.UID}\`)}
